...
import net.mythigame.commonsMGC.Kronos.managers.KickManager;
...
public class kickCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(sender instanceof Player moderator){
            ...
            if(account != null){
                ...
                KickManager kickManager = new KickManager(targetAccount, moderator, reason);
                kickManager.kick();
            }
        }
    ...
    private void helpMessage(CommandSender sender){
        sender.sendMessage("§c[Kronos] Usage : /kick <player> <reason>");
    }
