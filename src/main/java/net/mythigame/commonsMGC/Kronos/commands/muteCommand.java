...
import net.mythigame.commonsMGC.Kronos.managers.MuteManager;
...
public class muteCommand implements CommandExecutor, TabCompleter {
        ...
        if(sender instanceof Player moderator){
            ...
            if(account != null){
                ...
                if(time.equals("permanent") || time.equals("perma")){
                    ...
                    MuteManager muteManager = new MuteManager(moderator, targetAccount, reason);
                    muteManager.mute();
                }else{
                    ...
                    MuteManager muteManager = new MuteManager(moderator, targetAccount, reason, banTime);
                    muteManager.mute();
                }
            }
        }
    ...
    private void helpMessage(CommandSender sender){
        sender.sendMessage("§c[Kronos] Usage : /mute <player> <time> <timeKey> <reason>");
    }
