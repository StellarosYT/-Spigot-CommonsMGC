...
public class gmspCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if(args.length == 0){
            ...
            player.sendMessage("§9[Zeus] Vous êtes désormais en gamemode spectateur.");
            ...
            target.sendMessage("§9[Zeus] Vous êtes désormais en gamemode spectateur.");
            player.sendMessage("§9[Zeus] " + target.getName() + " est désormais en gamemode spectateur.");
